...
<body>
	<form action="${modify}" method="POST">
		<ul type="none">
			...
			<li>글제목: <input type="text" name="board_title" value="${board.board_title }"/><input type="hidden" value="${board.board_id }"/></li>
			<li>작성자: <input type="text" name="board_writer" value="${board.board_writer }" readonly/></li>
			<li>비밀번호:
			...
			<li>글내용: <textarea name="board_content" cols="63" rows="12">
